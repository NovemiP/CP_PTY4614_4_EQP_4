...
<main>
    ...
    <nav class="px-3 py-2 bg-white rounded shadow d-flex justify-content-between align-items-center">
        ...
        <!--Contenido-->
        <h3 class="title fw-bold mt-3 mb-3 me-auto">Registrar cliente</h3>
                    ...
                    <div class="col-12 col-md-4">
                        <form class="row form-registro mx-auto" action="../controllers/clienteController.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="telefono" name="telefono" pattern="[0-9]{8}" title="Debe contener 8 dígitos" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <a href="vista_clientes.php" class="btn btn-md btn-success">Cerrar</a>
                            </div>
                        </form>
                    </div>
                </div>
