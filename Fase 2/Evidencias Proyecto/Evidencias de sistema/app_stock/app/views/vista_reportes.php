...
<main>
    <div class="p-2">
        ...
        <!--Contenido-->
        <h3 class="title fw-bold mt-3 mb-0 me-auto">Reportes</h3>
        <!-- reportes-->
        <div class="row justify-content-center">
            <div class="col-12 col-md-4">
                <form id="formReporte" class=" mt-3" method="POST" action="../libs/reportes.php" target="_blank">
                    <!-- Select Reporte -->
                    <div class="mb-3">
                        <select class="form-select" name="reporteTipo" id="reporteTipo">
                            <option value="" disabled selected>Seleccionar tipo reporte</option>
                            <option value="inventario">Reporte de inventario</option>
                            <option value="movimientos">Reporte de movimientos</option>
                            <option value="existencia baja">Reporte de existencia crítica</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 col-md-11">
                        ...
                        <input type="date" id="fechaInicio" name="fechaInicio" class="form-control mb-3">

                        <label for="fechaFin">Fecha Fin</label>
                        <input type="date" id="fechaFin" name="fechaFin" class="form-control mb-3">
                    </div>
