...
<main>
    <div class="p-2">
        ...
        <!-- Fin Navbar -->
        <!--Contenido-->
        <h3 class="title fw-bold mt-3 mb-3 me-auto">Registro de usuarios</h3>
        <!-- formulario ingresar categoria-->
        <div class="container-fluid">
            <div class="mb-3">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-4">
                        <form class="row form-registro mx-auto" action="../controllers/usuarioController.php" method="POST" onsubmit="return validarContraseñas();">
                            <div class="mb-3">
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <a href="vista_usuarios.php" class="btn btn-md btn-success">Cerrar</a>
                            </div>
                        </form>
