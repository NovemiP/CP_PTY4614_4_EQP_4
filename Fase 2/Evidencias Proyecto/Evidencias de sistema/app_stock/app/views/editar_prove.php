...
if (isset($_GET['id_proveedor'])) {
    ...
    if (!$proveedor) {
        echo "Error: No se encontraron los datos del proveedor.";
        exit();
    }
} else {
    echo "Error: ID del proveedor no especificado.";
    exit();
}
...
<main>
    <div class="p-2">
        ...
        <!--Contenido-->
        <h3 class="title fw-bold mt-3 mb-3 me-auto">Editar proveedor</h3>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <form class="row form-registro mx-auto" action="../controllers/proveedorController.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombre_prove" name="nombre_prove" value="<?php echo htmlspecialchars($proveedor['nombre_prove']); ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="ciudad" name="ciudad" value="<?php echo htmlspecialchars($proveedor['ciudad']); ?>" required>
                            </div>

                            <div class="mb-3">
                                <label for="telefono" class="form-label">Teléfono</label>
                                <input type="tel" class="form-control" id="telefono" name="telefono" value="<?php echo htmlspecialchars($proveedor['telefono']); ?>" pattern="[0-9]{8}" title="Debe contener 8 dígitos" required>
                            </div>

                            <div class="mb-3">
                                <label for="correo" class="form-label">Correo</label>
                                <input type="email" class="form-control" id="correo" name="correo" value="<?php echo htmlspecialchars($proveedor['correo']); ?>" required>
                            </div>
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <a href="vista_proveedores.php" class="btn btn-md btn-secondary">Cerrar</a>
                            </div>
                        </form>
